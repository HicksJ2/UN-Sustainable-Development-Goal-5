...
SDG_Divorce<-read.csv("C:/Users/JHicks/Documents/R/UN_SDG/SDG_Divorce.csv")
```
...
p1+ ggtitle("Subpopulation denoted by Biological Sex") +
  xlab("PC1") + ylab("PC2")
```
...
p1<-ggplot(SDG_Chores_Numeric_no_year,aes(x=SDG_Chore_PCA$x[,1],y=SDG_Chore_PCA$x[,2],colour=Legend))+geom_point(size=2)
p1+ ggtitle("Subpopulation denoted by developed areas") +
  xlab("PC1") + ylab("PC2")
```
...
p1<-ggplot(SDG_Chores_Numeric_no_year,aes(x=SDG_Chore_PCA$x[,1],y=SDG_Chore_PCA$x[,2],colour=Legend))+geom_point(size=2)
p1+ ggtitle("Subpopulation denoted by Continent") +
  xlab("PC1") + ylab("PC2")
```
...
The chunk below displays the top variables used to improve the model performance.
...
country_chores_rural_m<-aggregate(country_chores_rural_m[,3],list(country_chores_rural_m$ISO3),mean)
...
map_variables_r_m<-mapCountryData(chores_rural_m_map,nameColumnToPlot ="x",oceanCol = "azure1",catMethod = "pretty",missingCountryCol = gray(.7),addLegend = T,mapTitle = "Percentage of Time spent on Domestic work - Rural Male Population", borderCol ="black",colourPalette = colorScale)
...
map_variables_r_m<-mapCountryData(chores_rural_f_map,nameColumnToPlot ="x",oceanCol = "azure1",catMethod = "pretty",missingCountryCol = gray(.7),addLegend = T,mapTitle = "Percentage of Time spent on Domestic work - Rural Female Population", borderCol ="black",colourPalette = colorScale)
...
map_variables_r_m<-mapCountryData(chores_urban_m_map,nameColumnToPlot ="x",oceanCol = "azure1",catMethod = "pretty",missingCountryCol = gray(.7),addLegend = T,mapTitle = "Percentage of Time spent on Domestic work - Urban Male Population", borderCol ="black",colourPalette = colorScale)
...
map_variables_r_m<-mapCountryData(chores_urban_f_map,nameColumnToPlot ="x",oceanCol = "azure1",catMethod = "pretty",missingCountryCol = gray(.7),addLegend = T,mapTitle = "Percentage of Time spent on Domestic work - Urban Female Population", borderCol ="black",colourPalette = colorScale)
...
map_variables_r_m<-mapCountryData(chores_all_m_map,nameColumnToPlot ="x",oceanCol = "azure1",catMethod = "pretty",missingCountryCol = gray(.7),addLegend = T,mapTitle = "Percentage of Time spent on Domestic work - Male Population", borderCol ="black",colourPalette = colorScale)
...
map_variables_r_m<-mapCountryData(chores_all_m_map,nameColumnToPlot ="x",oceanCol = "azure1",catMethod = "pretty",missingCountryCol = gray(.7),addLegend = T,mapTitle = "Percentage of Time spent on Domestic work - Female Population", borderCol ="black",colourPalette = colorScale)
...
```{r}
SDG_Divorce_filter<-SDG_Divorce%>%filter(Reliability=="Final figure, complete")
divorce_keep_colunms<-c("Country.or.Area","Year","Area","Value")
SDG_Divorce_filter<-SDG_Divorce_filter[,names(SDG_Divorce_filter)%in%divorce_keep_colunms]
SDG_Divorce_filter[["ISO3"]]<-
